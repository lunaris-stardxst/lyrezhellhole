SMODS.Joker{ --the hell joker
    ...
    calculate = function(self, card, context)
        if context.cardarea == G.jokers and context.joker_main  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_87f780ed', 1, card.ability.extra.odds, 'j_lzh_helloker', false) then
    ...
    delay(0.6)
                ...
                if SMODS.pseudorandom_probability(card, 'group_1_1f9bd34d', 1, card.ability.extra.odds2, 'j_lzh_helloker', false) then
              local created_joker = true
                ...
                if SMODS.pseudorandom_probability(card, 'group_2_b351dd06', 3, card.ability.extra.odds3, 'j_lzh_helloker', false) then
              local created_joker = true
                  G.E_MANAGER:add_event(Event({
                      func = function()
                ...
                if SMODS.pseudorandom_probability(card, 'group_3_691cdee0', 26, card.ability.extra.odds4, 'j_lzh_helloker', false) then
              local created_joker = true
                  G.E_MANAGER:add_event(Event({
                      func = function()
